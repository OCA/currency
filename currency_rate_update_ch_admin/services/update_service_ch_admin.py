...
class CHAdminGetter(CurrencyGetterInterface):
    ...
    allowed_base_currencies = [
        "EUR", "USD", "EGP", "ALL", "ARS", "AZN", "ETB", "AUD", "BHD", "BDT",
        "BAM", "BRL", "BGN", "CLP", "CNY", "CRC", "DKK", "DOP", "GBP", "GTQ",
        "HNL", "HKD", "INR", "IDR", "ISK", "ILS", "JPY", "KYD", "KHR", "CAD",
        "KZT", "QAR", "KES", "COP", "HRK", "KWD", "LBP", "LYD", "MYR", "MAD",
        "MUR", "MXN", "NZD", "NGN", "NOK", "OMR", "PKR", "PAB", "PEN", "PHP",
        "PLN", "RON", "RUB", "SAR", "SEK", "RSD", "SGD", "LKR", "KRW", "ZAR",
        "TWD", "TZS", "THB", "CZK", "TND", "TRY", "UAH", "HUF", "UYU", "VEF",
        "AED", "CHF"]
    ...
    def get_updated_currency(self, currency_array, main_currency,
        ...
        rate_date_datetime = fields.Datetime.from_string(rate_date)
